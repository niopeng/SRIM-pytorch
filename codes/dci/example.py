...
def main(*args):
    ...
    hdci_db = DCI(dim, num_comp_indices, num_simp_indices)
    hdci_db.add(data, num_levels = num_levels, field_of_view = construction_field_of_view, prop_to_retrieve = construction_prop_to_retrieve)
    ...
    nearest_neighbour_idx, nearest_neighbour_dists = hdci_db.query(queries, num_neighbours = num_neighbours, field_of_view = query_field_of_view, prop_to_retrieve = query_prop_to_retrieve, blind=True)
