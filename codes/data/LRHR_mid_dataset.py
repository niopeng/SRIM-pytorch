...
class LRHRMidDataset(data.Dataset):
    '''
    ...
    def __init__(self, opt):
        super(LRHRMidDataset, self).__init__()
        self.opt = opt
        self.paths_LR = None
        self.paths_HR = None
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            img_LR, img_HR, img_D1, img_D2 = util.augment([img_LR, img_HR, img_D1, img_D2], self.opt['use_flip'], \
                self.opt['use_rot'])
        ...
        return {'LR': img_LR, 'HR': img_HR, 'LR_path': LR_path, 'HR_path': HR_path,
                'D1': img_D1, 'D2': img_D2, 'D1_path': D1_path, 'D2_path': D2_path}
